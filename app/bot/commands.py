...
BOT_COMMANDS: tuple[tuple[str, str], ...] = (
    ...
    # Групповые команды (видны только в группах)
    ("rules", "Правила чата"),
    ("top", "Топ активных участников"),
    ("chatstats", "Статистика чата"),
    # AI-команды в группах
    ("sentiment", "AI-анализ тональности сообщения"),
    ("summarise", "AI-резюме чата (только админам)"),
    ("translate", "AI-перевод сообщения"),
    ("aimod", "AI-модерация: on/off"),
)
